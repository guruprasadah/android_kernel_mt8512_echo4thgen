...
static const struct life_cycle_reasons_data lcr_data[] = {
	...
	/* Device shutdown due to overheated Back1 virtual sensor */
	{
		THERMAL_SHUTDOWN_REASON_B1VS,
		"Back1 Virtual Sensor Overheated Thermal Shutdown",
		lcr_abnormal
	},
	/* Device shutdown due to overheated Case1 virtual sensor */
	{
		THERMAL_SHUTDOWN_REASON_C1VS,
		"Case1 Virtual Sensor Overheated Thermal Shutdown",
		lcr_abnormal
	},
	...
	/* Device shutdown due to overheated Back virtual sensor */
	{
		THERMAL_SHUTDOWN_REASON_BVS,
		"Back Virtual Sensor Overheated Thermal Shutdown",
		lcr_abnormal
	},
	/* Device shutdown due to overheated CPU virtual sensor */
	{
		THERMAL_SHUTDOWN_REASON_CPVS,
		"CPU Virtual Sensor Overheated Thermal Shutdown",
		lcr_abnormal
	},
