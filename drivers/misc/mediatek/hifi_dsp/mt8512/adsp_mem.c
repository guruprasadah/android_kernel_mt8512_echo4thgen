...
EXPORT_SYMBOL(adsp_get_shared_sysram_phys2virt);
...
EXPORT_SYMBOL(adsp_get_shared_sysram_virt2phys);
...
EXPORT_SYMBOL(adsp_hal_phys_addr_cpu2dsp);
...
EXPORT_SYMBOL(adsp_hal_phys_addr_dsp2cpu);
